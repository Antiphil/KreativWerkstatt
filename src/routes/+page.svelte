...
<div class="text-[#353338]">
	<div class="overflow-hidden">
		<div class="relative container">
			<div class="mx-auto max-w-prose text-base lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-8">
				<div>
					<h2 class="text-lg font-semibold text-secondary">Wir sind:</h2>
					<h3 class="mt-2 text-3xl font-bold leading-8 tracking-tight sm:text-4xl">Die KreativWerkstatt!</h3>
				</div>
			</div>
			<div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
				<div class="relative lg:col-start-2 lg:row-start-1">
					...
					<div class="relative mx-auto max-w-prose text-base lg:max-w-none">
						<figure>
							...
							<figcaption class="mt-3 flex text-sm items-center justify-center">
								<svg class="h-5 w-5 flex-none text-secondary" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
				...
				<div class="mt-8 lg:mt-0">
					...
					<div class="prose prose-indigo mx-auto mt-5 lg:col-start-1 lg:row-start-1 lg:max-w-none">
	...
	<div class="container">
		<div class=" text-base leading-7">
			<p class="text-base font-semibold leading-7">Lorem Ipsum</p>
			<h1 class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Aliquet nec orci mattis amet quisque</h1>
			...
			<div class="mt-10">
				...
				<ul role="list" class="mt-8 max-w-xl space-y-8">
					<li class="flex gap-x-3">
						<svg class="mt-1 h-5 w-5 flex-none" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
							<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
						</svg>
						<span><strong class="font-semibold">Data types.</strong> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</span>
					</li>
					<li class="flex gap-x-3">
						<svg class="mt-1 h-5 w-5 flex-none" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
							<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
						</svg>
						<span><strong class="font-semibold">Loops.</strong> Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
					</li>
					<li class="flex gap-x-3">
						<svg class="mt-1 h-5 w-5 flex-none" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
							<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
						</svg>
						<span><strong class="font-semibold">Events.</strong> Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
					</li>
				</ul>
				<p class="mt-8">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id blandit molestie auctor fermentum dignissim. Lacus diam tincidunt ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing egestas. Iaculis convallis ac tempor et ut. Ac lorem vel integer orci.</p>
				<h2 class="mt-16 text-2xl font-bold tracking-tight">Aliquet nec orci mattis amet quisque</h2>
				...
				<figure class="mt-10 border-l border-indigo-600 pl-9">
					...
					<figcaption class="mt-6 flex gap-x-4">
						...
						<div class="text-sm leading-6"><strong class="font-semibold">Maria Hill</strong> – Marketing Manager</div>
					</figcaption>
				</figure>
			...
			<div class="mt-16">
				<h2 class="text-2xl font-bold tracking-tight">Everything you need to get up and running</h2>
